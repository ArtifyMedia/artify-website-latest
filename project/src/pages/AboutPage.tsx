        ...
        <section className="py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-20">
              <div className="inline-block mb-6">
                <div className="px-4 py-2 bg-[#C8F31D]/10 border border-[#C8F31D]/30 rounded-full">
                  <span className="text-[#C8F31D] text-sm font-semibold">ABOUT ARTIFY MEDIA</span>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto mb-24">
              <div className="backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-3xl p-10">
                <Target className="w-12 h-12 text-[#C8F31D] mb-6" />
              ...
              <div className="backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-3xl p-10">
                <Rocket className="w-12 h-12 text-[#C8F31D] mb-6" />
            ...
            <div className="max-w-6xl mx-auto mb-24">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {values.map((value, index) => (
                  ...
                  >
                    <value.icon className="w-10 h-10 text-[#C8F31D] mb-4" />
            ...
            <div className="max-w-6xl mx-auto mb-24">
              ...
              <div className="grid md:grid-cols-4 gap-8">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className="backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-2xl p-8 text-center hover:border-[#C8F31D]/50 transition-all duration-300"
                  >
                    <div className="text-4xl md:text-5xl font-bold text-[#C8F31D] mb-2">
                      {stat.value}
                    </div>
            ...
            <div className="max-w-6xl mx-auto mb-24">
              ...
              <div className="backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-3xl p-12">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {team.map((member, index) => (
                  <div
                    ...
                    className="backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-2xl p-8 hover:border-[#C8F31D]/50 transition-all duration-300"
                  >
                    <h3 className="text-2xl font-bold text-[#C8F31D] mb-3">{member.role}</h3>
