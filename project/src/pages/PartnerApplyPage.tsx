...
export function PartnerApplyPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#060606] pt-20">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(34,197,94,0.05)_0%,transparent_50%)]"></div>
            ...
            <div className="text-center mb-12">
              <div className="inline-block mb-6">
                <div className="px-4 py-2 bg-[#C8F31D]/10 border border-[#C8F31D]/30 rounded-full">
                  <span className="text-[#C8F31D] text-sm font-semibold">PARTNER APPLICATION</span>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-[#C8F31D]/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 transition-colors"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-[#C8F31D]/20 rounded-xl text-white focus:outline-none focus:border-[#C8F31D]/50 transition-colors [&>option]:text-black [&>option]:bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full px-4 py-3 bg-white/5 border border-[#C8F31D]/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 transition-colors resize-none"
                ...
                <button
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-[#C8F31D] to-[#C8F31D] hover:from-green-600 hover:to-[#B8E30D] text-black font-bold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg shadow-[#C8F31D]/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
