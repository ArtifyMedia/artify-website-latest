            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              <div className="inline-block mb-6">
                <div className="px-4 py-2 bg-[#C8F31D]/10 border border-[#C8F31D]/30 rounded-full">
                  <span className="text-[#C8F31D] text-sm font-semibold">INSIGHTS & EXPERTISE</span>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-white/5 border border-[#C8F31D]/20 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50"
                  />
                </div>
            ...
            {featuredPost && (
              <div className="max-w-6xl mx-auto mb-16">
                <Link
                  ...
                  className="group block backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-3xl overflow-hidden hover:border-[#C8F31D]/50 transition-all duration-300"
                >
                  <div className="grid md:grid-cols-2 gap-0">
                    ...
                    <div className="p-8 md:p-12 flex flex-col justify-center">
                      <div className="flex items-center gap-4 mb-4">
                        <span className="px-3 py-1 bg-[#C8F31D]/20 text-[#C8F31D] text-sm font-semibold rounded-full">
                          Featured
                        </span>
                      ...
                      <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 group-hover:text-[#C8F31D] transition-colors">
                        {featuredPost.title}
                      </h2>
                      ...
                      <div className="flex items-center gap-2 text-[#C8F31D] font-semibold group-hover:gap-4 transition-all">
                        Read Article
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {regularPosts.map((post) => (
                <Link
                  key={post.id}
                  to={`/blog/${post.slug}`}
                  className="group backdrop-blur-sm bg-white/5 border border-[#C8F31D]/20 rounded-2xl overflow-hidden hover:border-[#C8F31D]/50 transition-all duration-300 flex flex-col"
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-[#C8F31D] transition-colors line-clamp-2">
                      {post.title}
                    </h3>
