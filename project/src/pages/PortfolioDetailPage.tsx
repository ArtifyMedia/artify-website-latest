    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-4 py-24 text-center">
          <div className="text-[#C8F31D]">Loading...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-black">
        ...
        <div className="container mx-auto px-4 py-24 text-center">
          ...
          <Link
            to="/portfolio"
            className="inline-flex items-center gap-2 text-[#C8F31D] hover:underline"
          >
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden bg-black mb-8 border border-[#C8F31D]/20" style={{ padding: '56.25% 0 0 0' }}>
              <iframe
            ...
            <div className="grid md:grid-cols-3 gap-8">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {item.tags.map((tag) => (
                        <span
                          key={tag}
                          className="px-4 py-2 bg-white/5 border border-[#C8F31D]/30 rounded-full text-sm text-gray-300"
                        >
                          {tag}
                        </span>
                      ))}
              ...
              <div>
                {item.services_used.length > 0 && (
                  <div className="bg-white/5 border border-[#C8F31D]/20 rounded-xl p-6">
                    <h3 className="text-xl font-bold text-white mb-4">Services Used</h3>
