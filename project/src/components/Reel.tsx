      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-400">through our lens</p>
          </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-black">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-24 h-24 bg-[#C8F31D] rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                    <Play className="w-12 h-12 text-black ml-2" fill="currentColor" />
                  </div>
                  <p className="text-white text-lg font-semibold">Watch Our Showreel</p>
                </div>
              </div>
            </div>

            <div className="absolute inset-0 border-2 border-[#C8F31D]/20 group-hover:border-[#C8F31D]/50 rounded-2xl transition-colors duration-300"></div>
          </div>
      ...
      {showReel && featuredVideo && (
        ...
        >
          <div className="relative w-full max-w-5xl" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setShowReel(false)}
              className="absolute -top-12 right-0 text-white hover:text-[#C8F31D] transition-colors text-sm"
            >
              Close ✕
            </button>
