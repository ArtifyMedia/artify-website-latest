...
export function CheckoutModal({ isOpen, onClose }: CheckoutModalProps) {
  ...
  if (isSuccess) {
    return (
      <>
        <div className="fixed inset-0 bg-black/90 dark:bg-black/90 backdrop-blur-sm z-50" />
        <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-[#060606] border border-[#C8F31D]/20 rounded-2xl p-8 max-w-md w-full text-center">
            <CheckCircle className="w-16 h-16 text-[#C8F31D] mx-auto mb-4" />
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Woohoo! You're In! 🎉</h2>
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          <div className="bg-white dark:bg-[#060606] border border-[#C8F31D]/20 rounded-2xl w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between p-6 md:p-8 border-b border-gray-200 dark:border-white/10 flex-shrink-0">
              <div>
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Let's Get This Party Started!</h2>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Fill out the form below and we'll make magic happen</p>
              </div>
              <button
                onClick={onClose}
                className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex-shrink-0 ml-4"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <div className="overflow-y-auto flex-1 p-6 md:p-8">
              <div className="mb-6 p-4 bg-[#C8F31D]/10 border border-[#C8F31D]/20 rounded-xl">
                <div className="flex items-center gap-2 mb-2">
                  <Sparkles className="w-4 h-4 text-[#C8F31D]" />
                  <span className="text-gray-700 dark:text-gray-400 text-sm font-semibold">Your Selected Services</span>
                  <span className="text-[#C8F31D] font-bold">({cartItems.length})</span>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white dark:bg-black/50 border ${errors.firstName ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all`}
                      placeholder="John"
                    />
                    {errors.firstName && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-black/50 border border-gray-300 dark:border-white/10 rounded-lg px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all"
                      placeholder="Doe"
                    />
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-white dark:bg-black/50 border ${errors.clientEmail ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all`}
                      ...
                      <button
                        ...
                        className={`px-4 py-3 rounded-lg border-2 transition-all ${
                          formData.customerType === type
                            ? 'border-[#C8F31D] bg-[#C8F31D]/10 text-gray-900 dark:text-white font-semibold'
                            : 'border-gray-300 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:border-[#C8F31D]/50'
                        }`}
                      >
                        {type}
                      </button>
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full bg-white dark:bg-black/50 border ${errors.sellingWhat ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full bg-white dark:bg-black/50 border ${errors.biggestChallenge ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg px-4 py-3 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all resize-none`}
                    rows={3}
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full bg-white dark:bg-black/50 border ${errors.marketingBudget ? 'border-red-500' : 'border-gray-300 dark:border-white/10'} rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-[#C8F31D]/50 focus:ring-1 focus:ring-[#C8F31D]/20 transition-all`}
                  >
